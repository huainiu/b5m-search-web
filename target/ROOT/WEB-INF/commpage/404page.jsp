...
<div id="error" class="w980">
    <!--err-hd s-->
    <div class="err-hd">
    	<h1 class="logo"><a href="${b5mUrl}"><img src="http://y.b5mcdn.com/static/images/www/logo.png?t=${timeVersion }" /></a></h1>
    </div>
    <!--err-hd e-->
    <!--err-wrap s-->
    <div class="err-wrap">
        ...
        <div class="err-main">
        	<h2 class="err-result">矮油，您访问的页面找不到了</h2>
            <p class="err-reason">您要查看的网页可能已删除、名称已被更改，或者暂时不可用。</p>
...
function googleAnalyticsInit(login) {
	...
	_gaq.push(["_trackPageview","/stats/error/404/"+currURL]);
