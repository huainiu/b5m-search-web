                    ...
                    <ul class="prod-detail-price h-list mt20 cf">
                        <li class="item-odd">
                            ...
                            {{#if isDaigou}}
                                ...
                                <a href="{{searchPath}}{{daigouSource.Url}}" class="btn-bevel btn-bevel-3" lp="1" data-attr="100803" docid="{{daigouSource.DOCID}}" target="_blank"><i data-attr="100803"></i>帮我买</a>
                            {{else}}
