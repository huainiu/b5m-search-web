package com.b5m.search.compress;
...
public class JsCssCompassAppTest {
	...
	public void testExecute(){
		try {
			...
			path = path.substring(0, path.indexOf("b5m-search-web"));
	...
	public void execute(String projectPath) throws Exception {
		String dir = projectPath + "b5m-search-web/src/main/webapp/";
		InputStream in = new FileInputStream(projectPath + "b5m-search-web/src/test/java/com/b5m/search/compress/jslist.txt");
