...
<head>
	...
	<link rel="stylesheet" href="http://staticcdn.b5m.com//css/haiwai/america/header.css?t=${timeVersion}" />
...
<body>
    ...
    <script type="text/javascript" src="http://y.b5mcdn.com/scripts/sp/common.js,resultlist.js?t=${timeVersion}"></script>
