...
<head>
	...
	<link rel="stylesheet" href="http://y.b5mcdn.com/css/haiwai/Japan/header.css?t=${timeVersion}" />
...
<body>
	...
	<div class="wp">
        ...
        <div id="J_prod_list">
            ...
            <ul class="grid-view cf" id="recommand-container">
    ...
    <script type="text/javascript" src="http://y.b5mcdn.com/scripts/search/search_no_result_404.js"></script>
    <script type="text/javascript" src="http://y.b5mcdn.com/scripts/sp/resultlist.js?t=${timeVersion}"></script>
    <script type="text/javascript" src="http://y.b5mcdn.com/scripts/sp/common.js?t=${timeVersion}"></script>
    <script type="text/javascript">
	var resultPage = new ResultPage();
	//商品推荐
	resultPage.recommendProduct({col:"jpana",url:"${searchApiRecommandUrl}"}, function(json){
